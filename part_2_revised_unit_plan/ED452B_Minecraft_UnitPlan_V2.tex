...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[C]{\small\color{gray}ED452B \textperiodcentered\ Minecraft Education Coding FUNdamentals \textperiodcentered\ Piter Garcia}
\fancyfoot[C]{\small\color{gray}ED452B --- Spring 2026 \textperiodcentered\ Warner School of Education, University of Rochester \textperiodcentered\ Part 1 Draft \textperiodcentered\ Page \thepage}
...
\hline
\cellcolor{tableHeader}\color{white}\bfseries LESSON TITLE & \cellcolor{white}\color{black}\normalfont Minecraft Education Coding FUNdamentals: Algorithms, Agents, and Inclusive Design \\
\hline
\end{tabularx}
...
\hline
Unit Title & Minecraft Education Coding FUNdamentals \\
\hline
...
The March 2026 pilot lesson conducted by Mr.\ Romig (observed during placement) provided direct design intelligence. Students who skipped NPC instruction text became immediately stuck and frustrated. Coordinate-based commands produced confusion because students lacked spatial vocabulary context. High-ability students who finished quickly disengaged when no extension path existed. Students with regulation needs escalated during ambiguous wait periods (world-loading times of 2--10 minutes). These observations directly shaped the inclusive design choices below.
...
Student learning in this unit will be analyzed through patterns across the four lessons rather than through completion alone. The key questions: Do students increasingly demonstrate independence with algorithms? Can they explain how their code works? Does debugging become more strategic over time? The teacher will also examine whether supports such as planning sheets, partner roles, and click-path charts improve access without lowering expectations --- and whether any support created dependency rather than scaffolded growth.
...
\subsection{Next Revision}

The next revision of the unit (Part 2, due April 30, 2026) should be informed by student work, teacher observation notes, and exit ticket patterns from actual implementation in May--June 2026. That second version will tighten the rubric alignment with concrete evidence of what actually helped learners succeed, which supports were effective, and which students needed additional escalation to Tier 2 or Tier 3 supports.
